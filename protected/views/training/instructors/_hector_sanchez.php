<div class="details instructor-details">
	<div class="hgroup">
		...
		<h4><?php echo CHtml::link('Héctor "Karucha" Sanchez', array('/about-us', '#' => 'instructor-hector-sanchez')); ?></h4>
	</div>
	<div class="figure">
		<?php echo CHtml::image(Yii::app()->request->getBaseUrl(true).'/images/training/no-existent-image.png', 'Instructor', array()); ?>
	</div>
