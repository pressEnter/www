...
<?php $this->pageTitle = 'Capacitación GNU/Linux. Proponemos capacitarte para que puedas dominar este sistema, conociendo su arquitectura, funcionamiento interno, configuración y servicios, para poder adaptarlo a tus necesidades, acompañado por un profesional experto en el tema.'; ?>
<div class="article">
	<div class="header">
