    ...
    <div class="article" id="hector-sanchez">
      ...
      <div class="footer">
        <div class="footer-inner">
          <?php
          echo CHtml::link(
                  CHtml::image(Yii::app()->theme->baseUrl . '/images/icons/infocus-linkedin-logo-square2-24x24.png', 'Ver perfil de Héctor Sánchez en Linkedin', array('title' => 'Ver perfil de Héctor Sánchez en Linkedin')), 'http://www.linkedin.com/in/karucha', array('target' => '_blank')
          );
...
<?php echo CHtml::image(Yii::app()->request->getBaseUrl(true) . '/images/about-us/fernando-toledo-100x100-color.jpg', 'Fernando Toledo', array('title' => 'Fernando Toledo')); ?>
      ...
      <div class="footer">
        <div class="footer-inner">
          <?php
          echo CHtml::link(
                  CHtml::image(Yii::app()->theme->baseUrl . '/images/icons/infocus-linkedin-logo-square2-24x24.png', 'Ver perfil de Fernando Toledo en Linkedin', array('title' => 'Ver perfil de Fernando Toledo en Linkedin')), 'http://www.linkedin.com/in/ftoledo', array('target' => '_blank'));
     
          echo CHtml::link(
                  CHtml::image(Yii::app()->theme->baseUrl . '/images/icons/infocus-facebook-logo-square-24x24.png', 'Fernando Toledo en Facebook', array('title' => 'Fernando Toledo en Facebook')), 'http://www.facebook.com/nandiky', array('target' => '_blank')
          );
...
<?php echo CHtml::image(Yii::app()->request->getBaseUrl(true) . '/images/about-us/miguel-garcia-100x100-color.jpg', 'Miguel García', array('title' => 'Miguel García')); ?>
      ...
      <div class="footer">
        <div class="footer-inner">
          <?php
          echo CHtml::link(
                  CHtml::image(Yii::app()->theme->baseUrl . '/images/icons/infocus-linkedin-logo-square2-24x24.png', 'Ver perfil de Miguel García en Linkedin', array('title' => 'Ver perfil de Miguel García en Linkedin')), 'http://www.linkedin.com/in/zzmike', array('target' => '_blank')
          );
...
<?php echo CHtml::image(Yii::app()->request->getBaseUrl(true) . '/images/about-us/luciano-baraglia-100x100-color.jpg', 'Luciano Baraglia', array('title' => 'Luciano Baraglia')); ?>
      ...
      <div class="footer">
        <div class="footer-inner">
          <?php
          echo CHtml::link(
                  CHtml::image(Yii::app()->theme->baseUrl . '/images/icons/infocus-linkedin-logo-square2-24x24.png', 'Ver perfil de Luciano Baraglia en Linkedin', array('title' => 'Ver perfil de Luciano Baraglia en Linkedin')), 'http://www.linkedin.com/in/lucianobaraglia', array('target' => '_blank')
          );
          echo CHtml::link(
                  CHtml::image(Yii::app()->theme->baseUrl . '/images/icons/infocus-facebook-logo-square-24x24.png', 'Luciano Baraglia en Facebook', array('title' => 'Luciano Baraglia en Facebook')), 'http://www.facebook.com/luciano.baraglia', array('target' => '_blank')
          );
          echo CHtml::link(
                  CHtml::image(Yii::app()->theme->baseUrl . '/images/icons/twitter-bird-24x24.png', 'Cuenta de Twitter', array('title' => 'Cuenta de Twitter')), 'https://twitter.com/lucianobaraglia', array('target' => '_blank')
          );
